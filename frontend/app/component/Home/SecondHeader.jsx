  ...
  return (
    ...
    >
      <div className="w-full lg:w-5/6 xl:w-8/12 py-4 md:py-2">
        {/* Container with Sale Zone and scrolling products */}
        <div className="flex w-full relative  md:py-6 overflow-hidden ">
          ...
          >
            ...
            <figcaption className="mt-5 text-sm text-center transition-colors duration-300 ease-in-out hover:text-red-400">
              Sale Zone
            </figcaption>
          </article>
