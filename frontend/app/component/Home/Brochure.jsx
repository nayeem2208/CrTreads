      ...
      <div className="w-11/12 md:w-full text-center">
        ...
        <a href={brochureUrl} download>
          <button class="cursor-pointer font-semibold overflow-hidden relative z-100 border border-green-500 group px-8 py-2">
            ...
            <span class="absolute w-full h-full bg-green-500 -left-42 top-0 -rotate-45 group-hover:rotate-0 group-hover:left-0 duration-500"></span>
            <span class="absolute w-full h-full bg-green-500 -right-42 top-0 -rotate-45 group-hover:rotate-0 group-hover:right-0 duration-500"></span>
          </button>
        </a>
      </div>
    </div>
